...
local function bomLanguage_Chinese()
  return {
    ...
    CHAT_MSG_PREFIX               = "Buffomat: ",
    Buffomat                      = "Buffomat", 
    ResetWatchGroups              = "将BUFF组重置为1至8队",
    FORMAT_BUFF_SINGLE            = "%s %s",
    ...
    TooltipMacroButton            = "将此宏拖动到您的动作条中以施放BUFF|您可以在按键绑定 =>其他中为宏添加快捷键 ",
