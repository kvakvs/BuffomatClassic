...
local function bomLanguage_English()
  return {
    ...
    MsgIsStealthed                = "In stealth (option in settings)",
    ...
    CboxInWorld                   = "Scan buffs in overworld",
...
local function bomLanguage_Russian()
  return {
    ...
    MsgCombat                     = "В бою",
    MsgIsResting                  = "В зоне отдыха (откл. в опциях)",
    MsgIsStealthed                = "Режим незаметности (откл. в опциях)",
    MsgDead                       = "Мертв",
