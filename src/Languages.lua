...
BOM.locales = {
  enEN = { --EN is Master/Fallback
    ...
    MsgCombat                     = "In Combat",
    MsgIsResting                  = "Rest Area (option in settings)",
    ...
    CboxInWorld                   = "Scan and buff in overworld",
    CboxInPVP                     = "Scan and buff in battlegrounds",
    CboxInInstance                = "Scan and buff in dungeons and raids",
  ...
  ruRU = {
    ...
    ["MsgCombat"]                     = "В бою",
    ["MsgIsResting"]                  = "В зоне отдыха (отключается в опциях)",
    ["MsgDead"]                       = "Мертв",
