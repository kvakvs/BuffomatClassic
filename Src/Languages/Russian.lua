...
local russianModule = BomModuleManager.languageRussianModule ---@type BomLanguageRussianModule
...
function russianModule:Translations()
    return {
        ...
        TooltipCastButton =
        "Скастовать заклинание из списка.|nКнопка становится недоступной в бою.|nТакже можно использовать макро (вытащите кнопку Макро сверху на панель заклинаний)|nили привязать клавишу в Настройках - Прочие",
