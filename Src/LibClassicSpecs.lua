-- Retail GetSpecialization* methods in Classic
-- https://github.com/tstirrat/LibClassicSpecs
local MAJOR, MINOR = "LibClassicSpecs", 1000 + tonumber(strmatch("@project-revision@", "%d+") or 0)
--local lib = LibStub:NewLibrary(MAJOR, MINOR)
---@class LibClassicSpecsModule
local lib = BuffomatModule.New("LibClassicSpecs") ---@type LibClassicSpecsModule
