...
local function bomLanguage_English()
  return {
    ...
    CboxDeactivateBomOnSpiritTap  = "Disable Buffomat if priest 'Spirit tap' is active",
...
local function bomLanguage_Russian()
  return {
    ...
    CboxHideSomeoneIsDrinking     = "Не показывать сообщение о том, что 'Кто-то пьёт'",
    CboxDeactivateBomOnSpiritTap  = "Запретить Бафомёт, если 'Захват духа' жреца активен",
