...
local function bomLanguage_Chinese()
  return {
    ...
    ["options.short.Time60"]                    = "持续时间 <=60 秒:",
    ["options.short.Time300"]                   = "持续时间 <=5 分:",
    ["options.short.Time600"]                   = "持续时间 <=10 分:",
    ["options.short.Time1800"]                  = "持续时间 <=30 分:",
    ["options.short.Time3600"]                  = "持续时间 <=60 分:",
    ["options.short.UIWindowScale"]             = "UI 比例 (默认 1; 隐藏和显示Buffomat设置)",
    ["options.short.MinBuff"]                   = "使用群体BUFF需达到多少人以上才使用",
    ["options.short.MinBlessing"]               = "使用强大的祝福需达到多少人以上才使用",
