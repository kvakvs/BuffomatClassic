...
function rogueModule:SetupRogueSpells(spells, enchants)
  local duration = allSpellsModule.TbcOrClassic(allSpellsModule.DURATION_1H, allSpellsModule.DURATION_30M) -- TBC: Poisons become 1 hour

  spellDefModule:createAndRegisterBuff(spells, 25351, --Deadly Poison
          { item         = allSpellsModule.ExpansionChoice(20844, 22054, 43233),
  ...
  spellDefModule:createAndRegisterBuff(spells, 11340, --Instant Poison
          { item         = allSpellsModule.TbcOrClassic(21927, 8928),
  ...
  spellDefModule:createAndRegisterBuff(spells, 13227, --Wound Poison
          { item         = allSpellsModule.TbcOrClassic(22055, 10922),
