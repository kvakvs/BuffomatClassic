...
function elixirsModule:_SetupBattleCasterElixirs(buffs, enchantments)
  buffDefModule:tbcConsumable(buffs, 28509, 22840) --TBC: Elixir of Major Mageblood +16 mp5
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:tbcConsumable(buffs, 28503, 22835, --TBC: Elixir of Major Shadow Power +55 SHADOW
          { playerClass = allBuffsModule.BOM_SHADOW_CLASSES })
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:tbcConsumable(buffs, 28501, 22833, --TBC: Elixir of Major Firepower +55 FIRE
          { playerClass = allBuffsModule.BOM_FIRE_CLASSES })
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:tbcConsumable(buffs, 28493, 22827, --TBC: Elixir of Major Frost Power +55 FROST
          { playerClass = allBuffsModule.BOM_FROST_CLASSES })
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:tbcConsumable(buffs, 28491, 22825, --TBC: Elixir of Healing Power +50 HEAL
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:tbcConsumable(buffs, 33721, 28103, --TBC: Adept's Elixir +24 SPELL, +24 SPELLCRIT
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:classicConsumable(buffs, 17539, 13454, --Greater Arcane Elixir
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.CLASSIC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:classicConsumable(buffs, 11390, 9155, --Greater Arcane Elixir
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.CLASSIC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:classicConsumable(buffs, 11474, 9264, -- Elixir of Shadow Power
          { playerClass = allBuffsModule.BOM_SHADOW_CLASSES })
               :Category(allBuffsModule.CLASSIC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:classicConsumable(buffs, 26276, 21546, --Elixir of Greater Firepower
          { playerClass = allBuffsModule.BOM_FIRE_CLASSES })
               :Category(allBuffsModule.CLASSIC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)

  buffDefModule:classicConsumable(buffs, 21920, 17708, --Elixir of Frost Power
          { playerClass = allBuffsModule.BOM_FROST_CLASSES })
               :Category(allBuffsModule.CLASSIC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_BATTLE)
end
...
function elixirsModule:_SetupGuardianElixirs(buffs, enchantments)
  buffDefModule:tbcConsumable(buffs, 39627, 32067, --TBC: Elixir of Draenic Wisdom +30 SPI
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  -- Visible in TBC but marked as Classic consumables
  buffDefModule:classicConsumable(buffs, 24363, 20007, --Mageblood Potion
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.CLASSIC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:classicConsumable(buffs, 11396, 9179, --Elixir of Greater Intellect +25
          nil)
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:tbcConsumable(buffs, 28514, 22848, --TBC: Elixir of Empowerment, -30 TARGET RESIST
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.TBC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:tbcConsumable(buffs, 17535, 13447, --TBC: Elixir of the Sages +18 INT/+18 SPI
          { playerClass = allBuffsModule.BOM_MANA_CLASSES })
               :Category(allBuffsModule.CLASSIC_SPELL_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:tbcConsumable(buffs, 33726, 28104) --TBC: Elixir of Mastery +15 all stats
               :Category(allBuffsModule.TBC_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:tbcConsumable(buffs, 28502, 22834) --TBC: Elixir of Major Defense +550 ARMOR
               :Category(allBuffsModule.TBC_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:tbcConsumable(buffs, 39628, 32068) --TBC: Elixir of Ironskin +30 RESIL
               :Category(allBuffsModule.TBC_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:tbcConsumable(buffs, 39625, 32062) --TBC: Elixir of Major Fortitude +250 HP and 10 HP/5
               :Category(allBuffsModule.TBC_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)

  buffDefModule:tbcConsumable(buffs, 39626, 32063) --TBC: Earthen Elixir -20 ALL DMG TAKEN
               :Category(allBuffsModule.TBC_ELIXIR)
               :ElixirType(allBuffsModule.ELIX_GUARDIAN)
