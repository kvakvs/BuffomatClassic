...
function mageModule:SetupMageSpells(allBuffs, enchants)
  ...
  tinsert(allBuffs, BOM.SpellDef_ArcaneIntelligence())

  buffDefModule:createAndRegisterBuff(allBuffs, 10174, --Dampen Magic
          { default      = false, singleDuration = allBuffsModule.DURATION_10M,
            singleFamily = { 604, 8450, 8451, 10173, 10174, -- Ranks 1-5
               ...
               :RequirePlayerClass("MAGE")
               :Category(allBuffsModule.CLASS)
  buffDefModule:createAndRegisterBuff(allBuffs, 10170, --Amplify Magic
          { default      = false, singleDuration = allBuffsModule.DURATION_10M,
            singleFamily = { 1008, 8455, 10169, 10170, -- Ranks 1-4
               ...
               :RequirePlayerClass("MAGE")
               :Category(allBuffsModule.CLASS)
  buffDefModule:createAndRegisterBuff(allBuffs, 10220, -- Ice Armor / eisrüstung
          { type         = "seal", default = false,
            singleFamily = { 168, 7300, 7301, -- Frost Armor 1-3
               ...
               :RequirePlayerClass("MAGE")
               :Category(allBuffsModule.CLASS)
  buffDefModule:createAndRegisterBuff(allBuffs, 11426, -- Ice Barrier
          { type         = "seal", default = false, singleDuration = 60,
            singleFamily = { 11426, 13031, 13032, 13033, -- Ice Barrier 1-4
               ...
               :RequirePlayerClass("MAGE")
               :Category(allBuffsModule.CLASS)
  buffDefModule:createAndRegisterBuff(allBuffs, 30482, -- TBC: Molten Armor
          { type         = "seal", default = false,
            singleFamily = { 30482, -- TBC: Molten Armor 1
                             43045, 43046 } }) -- WotLK: Molten Armor 2, 3
               :RequirePlayerClass("MAGE")
               :Category(allBuffsModule.CLASS)
  buffDefModule:createAndRegisterBuff(allBuffs, 22783, -- Mage Armor / magische rüstung
          { type         = "seal", default = false,
            singleFamily = { 6117, 22782, 22783, -- Mage Armor 1-3
               ...
               :RequirePlayerClass("MAGE")
               :Category(allBuffsModule.CLASS)
  buffDefModule:createAndRegisterBuff(allBuffs, 10193, --Mana Shield | Manaschild - unabhängig von allen.
  ...
  if playerLevel >= 58 and playerLevel < 77 then
    ...
    buffDefModule:createAndRegisterBuff(allBuffs, spellIdsModule.Mage_ConjureManaEmerald, -- Conjure Mana Stone (Max Rank)
