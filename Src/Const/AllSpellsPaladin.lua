...
function paladinModule:SetupPaladinSpells(allBuffs, enchants)
  buffDefModule:createAndRegisterBuff(allBuffs, 25780, --Righteous Fury, same in TBC
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 20217, -- Blessing of Kings
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 19979, -- Blessing of Light (classic and TBC only)
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 25291, -- Blessing of Might
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 1038, -- Blessing of Salvation (classic and TBC only)
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 25290, -- Blessing of Wisdom
          { isBlessing     = true, default = false,
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 20914, -- Blessing of Sanctuary
          { isBlessing     = true, default = false,
  ...
  -- GREATER BLESSINGS
  --
  buffDefModule:createAndRegisterBuff(allBuffs, 25898, -- Greater Blessing of Kings
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 25890, -- Greater Blessing of Light
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 25916, --Greater Blessing of Might
          { isBlessing      = true, default = false,
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 25895, --Greater Blessing of Salvation
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 25918, --Greater Blessing of Wisdom
          { isBlessing      = true, default = false,
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 25899, --Greater Blessing of Sanctuary
          { isBlessing      = true, default = false,
  ...
  -- ----------------------------------
  --
  buffDefModule:createAndRegisterBuff(allBuffs, 10293, -- Devotion Aura
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 10301, -- Retribution Aura
          { type         = "aura", default = true,
            singleFamily = { 7294, 10298, 10299, 10300, 10301, -- Retribution Aura 1-5
                ...
                :Category(allBuffsModule.AURA)
  buffDefModule:createAndRegisterBuff(allBuffs, 19746, --Concentration Aura
          { type = "aura", default = false
          })    :RequirePlayerClass("PALADIN")
                :Category(allBuffsModule.AURA)
  buffDefModule:createAndRegisterBuff(allBuffs, 19896, -- Shadow Resistance Aura
          { type         = "aura", default = false,
            singleFamily = { 19876, 19895, 19896, -- Shadow Resistance Aura 1-3
                ...
                :Category(allBuffsModule.AURA)
  buffDefModule:createAndRegisterBuff(allBuffs, 19898, -- Frost Resistance Aura
          { type         = "aura", default = false,
            singleFamily = { 19888, 19897, 19898, -- Frost Resistance Aura 1-3
                ...
                :Category(allBuffsModule.AURA)
  buffDefModule:createAndRegisterBuff(allBuffs, 19900, -- Fire Resistance Aura
          { type         = "aura", default = false,
            singleFamily = { 19891, 19899, 19900, -- Fire Resistance Aura 1-3
                ...
                :Category(allBuffsModule.AURA)
  buffDefModule:createAndRegisterBuff(allBuffs, 20218, --Sanctity Aura (classic and TBC only)
          { type = "aura", default = false
          })    :RequirePlayerClass("PALADIN")
                :HideInWotLK()
                :Category(allBuffsModule.AURA)
  ...
  BOM.CrusaderAuraSpell = buffDefModule:createAndRegisterBuff(
          allBuffs, spellIdsModule.Paladin_CrusaderAura, --TBC: Crusader Aura
  ...
  -- ----------------------------------
  --
  buffDefModule:createAndRegisterBuff(allBuffs, 20773, -- Redemption / Auferstehung
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 20164, -- Sanctity Seal (classic and TBC only)
          { type = "seal", default = false
          })    :RequirePlayerClass("PALADIN")
                :HideInTBC()
                :Category(allBuffsModule.SEAL) -- classic only

  buffDefModule:createAndRegisterBuff(allBuffs, 5502, -- Sense undead
          { type = "tracking", default = false
          })    :RequirePlayerClass("PALADIN")
                :Category(allBuffsModule.TRACKING)

  buffDefModule:createAndRegisterBuff(allBuffs, 20165, -- Seal of Light
          { type         = "seal", default = false,
  ...
  buffDefModule:createAndRegisterBuff(allBuffs, 20154, -- Seal of Righteousness
          { type         = "seal", default = false,
            singleFamily = { 20154, 20287, 20288, 20289, 20290, 20291, 20292, 20293, -- Seal of Righteousness 1-8
                ...
                :Category(allBuffsModule.SEAL)
  buffDefModule:createAndRegisterBuff(allBuffs, 20166, -- Seal of Wisdom
          { type = "seal", default = false
          })    :RequirePlayerClass("PALADIN")
                :Category(allBuffsModule.SEAL)
  buffDefModule:createAndRegisterBuff(allBuffs, 348704, -- TBC: Seal of Vengeance
          { type         = "seal", default = false,
            singleFamily = { 31801, -- TBC: level 70 spell for Blood Elf
                             348704 }  -- TBC: Base spell for the alliance races
          })    :RequirePlayerClass("PALADIN")
                :Category(allBuffsModule.SEAL)
  buffDefModule:createAndRegisterBuff(allBuffs, 348700, -- TBC: Seal of the Martyr (Draenei, Dwarf, Human)
          { type = "seal", default = false
          })    :RequirePlayerClass("PALADIN")
                :Category(allBuffsModule.SEAL)
  buffDefModule:createAndRegisterBuff(allBuffs, 31892, -- TBC: Seal of Blood
          { type         = "seal", default = false,
            singleFamily = { 31892, -- TBC: Base Blood Elf spell
                             38008 }  -- TBC: Alliance version???
          })    :RequirePlayerClass("PALADIN")
                :Category(allBuffsModule.SEAL)
  buffDefModule:createAndRegisterBuff(allBuffs, 20375, -- TBC/WotLK: Seal of Command
          { type         = "seal", default = false,
            singleFamily = { 20375 }
          })    :RequirePlayerClass("PALADIN")
                :Category(allBuffsModule.SEAL)
