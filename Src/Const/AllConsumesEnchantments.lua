...
function enchantmentsModule:_SetupCasterEnchantments(buffs, enchantments)
  if BOM.IsTBC then
    spellDefModule:createAndRegisterBuff(buffs, 28017, --Superior Wizard Oil +42 SPELL
            { item          = 22522, items = { 22522 }, isConsumable = true,
              type          = "weapon", duration = allBuffsModule.DURATION_1H, default = false,
              onlyUsableFor = allBuffsModule.BOM_MANA_CLASSES })
                  :Category(allBuffsModule.WEAPON_ENCHANTMENT)
  end

  spellDefModule:createAndRegisterBuff(buffs, 25123, --Minor, Lesser, Brilliant Mana Oil
          { item     = 20748, isConsumable = true, type = "weapon",
            ...
            duration = allBuffsModule.DURATION_30M, default = false, onlyUsableFor = allBuffsModule.BOM_MANA_CLASSES })
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
  enchantments[25123] = { 2624, 2625, 2629, -- Minor, Lesser, Brilliant Mana Oil (enchant)
                      2677 } -- TBC: Superior Mana Oil (enchant)

  spellDefModule:createAndRegisterBuff(buffs, 25122, -- Wizard Oil
  ...
  spellDefModule:createAndRegisterBuff(buffs, 28898, --Blessed Wizard Oil
          { item     = 23123, isConsumable = true, type = "weapon",
            duration = allBuffsModule.DURATION_1H, default = false, onlyUsableFor = allBuffsModule.BOM_MANA_CLASSES })
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
...
function enchantmentsModule:_SetupPhysicalEnchantments(buffs, enchantments)
  ...
  --
  spellDefModule:createAndRegisterBuff(buffs, 16622, --Weightstone
          { item         = 12643, items = { 12643, 7965, 3241, 3240, 3239 },
            isConsumable = true, type = "weapon", duration = allBuffsModule.DURATION_30M,
            default      = false, onlyUsableFor = allBuffsModule.BOM_PHYSICAL_CLASSES, })
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
  enchantments[16622] = { 1703, 484, 21, 20, 19 } -- Weightstone

  spellDefModule:createAndRegisterBuff(buffs, 34340, --TBC: Adamantite Weightstone +12 BLUNT +14 CRIT
          { item    = 28421, items = { 28421 }, isConsumable = true, type = "weapon", duration = allBuffsModule.DURATION_1H,
            default = false, onlyUsableFor = allBuffsModule.BOM_PHYSICAL_CLASSES, })
                :ShowInTBC()
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
  enchantments[34340] = { 2955 } --TBC: Adamantite Weightstone (Weight Weapon)

  spellDefModule:createAndRegisterBuff(buffs, 34339, --TBC: Fel Weightstone +12 BLUNT
          { item    = 28420, items = { 28420 }, isConsumable = true, type = "weapon", duration = allBuffsModule.DURATION_1H,
            default = false, onlyUsableFor = allBuffsModule.BOM_PHYSICAL_CLASSES, })
                :ShowInTBC()
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
  ...
  --
  spellDefModule:createAndRegisterBuff(buffs, 16138, --Sharpening Stone
  ...
  spellDefModule:createAndRegisterBuff(buffs, 28891, --Consecrated Sharpening Stone
          { item     = 23122, isConsumable = true, type = "weapon",
            duration = allBuffsModule.DURATION_1H, default = false, onlyUsableFor = allBuffsModule.BOM_PHYSICAL_CLASSES, })
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
  enchantments[28891] = { 2684 } --Consecrated Sharpening Stone

  spellDefModule:createAndRegisterBuff(buffs, 22756, --Elemental Sharpening Stone
          { item     = 18262, isConsumable = true, type = "weapon",
            duration = allBuffsModule.DURATION_30M, default = false, onlyUsableFor = allBuffsModule.BOM_PHYSICAL_CLASSES, })
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
  enchantments[22756] = { 2506 } --Elemental Sharpening Stone

  spellDefModule:createAndRegisterBuff(buffs, 29453, --TBC: Adamantite Sharpening Stone +12 WEAPON +14 CRIT
          { item    = 23529, items = { 23529 }, isConsumable = true, type = "weapon", duration = allBuffsModule.DURATION_1H,
            default = false, onlyUsableFor = allBuffsModule.BOM_PHYSICAL_CLASSES, })
                :ShowInTBC()
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)

  spellDefModule:createAndRegisterBuff(buffs, 29452, --TBC: Fel Sharpening Stone +12 WEAPON
          { item    = 23528, items = { 23528 }, isConsumable = true, type = "weapon", duration = allBuffsModule.DURATION_1H,
            default = false, onlyUsableFor = allBuffsModule.BOM_PHYSICAL_CLASSES, })
                :ShowInTBC()
                :Category(allBuffsModule.WEAPON_ENCHANTMENT)
...
function enchantmentsModule:_SetupOtherEnchantments(buffs, enchantments)
  -- Rune of Warding
  --
  spellDefModule:createAndRegisterBuff(buffs, 32282, --TBC: Greater Rune of Warding
          { item           = 25521, isConsumable = true, default = false, consumableTarget = "player",
            ...
            playerClass = allBuffsModule.BOM_MELEE_CLASSES
          }):Category(allBuffsModule.WEAPON_ENCHANTMENT)
end
