...
function chineseModule:Translations()
  return {
    ...
    ["options.short.FadeWhenNothingToDo"]             = "无事可做的时候淡出 Buffomat 窗口",

    ["options.long.FadeWhenNothingToDo"]              = "无事可做时设置 Bufomat 窗口的透明度",
    ...
    ["options.long.SlowerHardware"]                   = "不太频繁的增益检查 (针对硬件不好的团队)",
