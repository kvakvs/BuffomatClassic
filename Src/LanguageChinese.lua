...
function chineseModule:Translations()
  return {
    ["shaman.flametongueDownranked"]                  = "下一等级",
    ...
    ["Category_classWeaponEnchantment"]               = "职业技能",
    ["Category_none"]                                 = "未分类",
    ...
    ["options.general.group.Buffing"]                 = "增益计时器",
    ["options.general.group.Visibility"]              = "显示分类",
	  ["options.general.group.Class"]                   = "打开选项",

    ["options.short.ActivateBomOnSpiritTap"]          = "在低于 % 的蓝量激活",
    ...
    ["options.short.Carrot"]                          = "警告：装备的物品",
    ["options.short.DeathBlock"]                      = "如果有人死亡就暂停",
    ["options.short.DontUseConsumables"]              = "不使用消耗品",
	  ["options.short.ShamanFlametongueRanked"]         = "萨满: 使用低等级的火舌",

    ["options.short.SomeoneIsDrinking"]               = "当有人在喝酒...",
    ["options.convenience.SomeoneIsDrinking.Hide"]    = "无视这个",
    ["options.convenience.SomeoneIsDrinking.LowPrio"] = "显示备注",
    ["options.convenience.SomeoneIsDrinking.Show"]    = "显示备注并显示Buffomat",

    ["options.short.InInstance"]                      = "地下城扫描",
    ["options.short.InPVP"]                           = "战场扫描",
    ["options.short.InWorld"]                         = "世界地图扫描",
    ["options.short.LockMinimapButton"]               = "锁定小地图图标",
    ["options.short.LockMinimapButtonDistance"]       = "小地图图标间距",
    ["options.short.MainHand"]                        = "缺少主手附魔",
    ["options.short.NoGroupBuff"]                     = "不使用群体增益",
    ["options.short.OpenLootable"]                    = "打开可拾取战利品",
    ...
    ["options.short.UseRank"]                         = "使用高等级增益",
    ["options.short.VisibleCategories"]               = "显示增益 (每个角色的设置)",
	  ["options.short.FadeWhenNothingToDo"]             = "无任务时淡入淡出窗口",

    ["options.long.FadeWhenNothingToDo"]              = "设置无事可做时Buffomat窗口的透明度",
    ...
    ["options.long.AutoStand"]                        = "如果你在坐着的状态, Buffomat会让你站起来",
    ...
    ["options.long.InInstance"]                       = "地下城和团本扫描增益",
    ["options.long.InPVP"]                            = "战场扫描增益",
    ["options.long.InWorld"]                          = "世界和城市扫描增益",
    ["options.long.LockMinimapButton"]                = "锁定小地图图标",
    ...
    ["options.long.SlowerHardware"]                   = "不太频繁的增益检查 (针对硬件不好/团队)",
	  ["options.long.SomeoneIsDrinking"]                = "当有人喝酒时，可以显示或隐藏消息",
    ["options.long.UseProfiles"]                      = "根据玩家个人/队伍/团队/战场使用配置文档",
	  ["options.long.UseRank"]                          = "使用有等级的技能",
    ["options.long.VisibleCategories"]                = "在技能列表中显示增益（每个角色设置）",
	  ["options.long.ShamanFlametongueRanked"]          = "萨满: 对于技能，萨满祭司在主手上使用最高等级的火舌武器，在非主手使用低等级。当你的武器速度匹配时，请启用",

    ["tasklist.IgnoredBuffOn"]                        = "忽略 %s: %s",
    ["task.target.Self"]                              = "自己", 
    ...
    ["castButton.BusyChanneling"]                     = "繁忙中/ 聊天",
    ...
    ["options.short.UIWindowScale"]                   = "UI 缩放",
    ...
    ["options.long.UIWindowScale"]                    = "UI 缩放，隐藏和显示Buffomat设置 (默认 1)",
    ["options.long.MinBuff"]                          = "群体增益使用需要缺失的数量",
    ["options.long.MinBlessing"]                      = "强效祝福使用需要缺失祝福的数量",

    TooltipSelfCastCheckbox_Self                      = "仅-自己",
    TooltipSelfCastCheckbox_Party                     = "队伍/团队的增益",
    TooltipEnableSpell                                = "添加增益到列表内",
    TooltipEnableBuffCancel                           = "发现这个增益就取消",
    FormatToggleTarget                                = "点击切换队伍: %s",
    FormatAllForceCastTargets                         = "强制施法: ",
    FormatForceCastNone                               = "强制施法列表",
    FormatAllExcludeTargets                           = "忽略: ",
    FormatExcludeNone                                 = "忽略列表",
    ...
    MessageClearedForced                              = "取消强制 Buff 到",
    ...
    TooltipIncludesAllRanks                           = "所有这类型BUFF",
    TooltipSimilar                                    = "任何类似的",
    TooltipSimilarFoods                               = "所有类型食物",

    ["tooltip.buff.agility"]                          = "+敏捷",
    ["tooltip.buff.allResist"]                        = "+所有物品",
    ["tooltip.buff.attackPower"]                      = "+攻击",
    ["tooltip.buff.crit"]                             = "+暴击",
    ["tooltip.buff.fireResist"]                       = "+火焰抗性",
    ["tooltip.buff.frostResist"]                      = "+冰霜抗性",
    ["tooltip.buff.haste"]                            = "+急速",
    ["tooltip.buff.healing"]                          = "+治疗",
    ["tooltip.buff.hit"]                              = "+命中",
    ["tooltip.buff.intellect"]                        = "+智力",
    ["tooltip.buff.maxHealth"]                        = "+最大生命值",
    ["tooltip.buff.mp5"]                              = "+回蓝/5",
    ["tooltip.buff.resilience"]                       = "+回复",
    ...
    ["tooltip.food.multipleFoodItems"]                = " (具有/相同Buff的各种食物)",
    ...
    ["profile.activeProfileMenuTag"]                  = "[主天赋]",
	  profile_solo                                      = "个人",
	  profile_solo_spec2                                = "个人 (第二天赋)",
    profile_group                                     = "队伍",
	  profile_group_spec2                               = "队伍 (第二天赋)",
    profile_raid                                      = "团队",
	  profile_raid_spec2                                = "团队 (第二天赋)",
    profile_battleground                              = "战场",
	  profile_battleground_spec2                        = "战场 (第二天赋)",
    profile_auto                                      = "自动",
